...
var T = {
  ...
  achv_cit10_desc: "Ku guuleyso 10 Citizen ahaan",
  achv_games100_name: "\u{1F3AE} Veteran",
  achv_games100_desc: "Ku ciyaar 100 ciyaar",
...
\u{1F480} **${lostXP} XP** waa la waysay!
\u{1F4CA} Tallaabooyinka: ${floor - 1} floor`,
  ...
  miino_timeout_desc: (id, xp) => `<@${id}> waqtigaagii wuu dhacay. ${xp} XP waa la waysay!`,
  miino_mine_title: "\u{1F4A3}\u{1F4A5} MIINO! \u2014 Qarax!",
  miino_mine_lost: (xp) => `

\u{1F480} **${xp} XP** waa la waaysay!`,
  miino_perfect_title: "\u{1F4A3}\u{1F3C6} MIINO \u2014 PERFECT CLEAR!",
  miino_perfect_desc: (bonus, total) => `

\u{1F389} Dhammaan safe tiles waa la furay!
...
\u{1F4CA} ${tiles} tile ayaad furatay.`,
  ...
  miino_tile_already: "\u26A0\uFE0F Tile-kan horey ayaa la furay.",
...
\u{1F605} **${name} cidna ma khiyaaneeyin.** +${xp} XP`,
...
Qofka kale ma arki karo.`,
  ...
  guess_cooldown: "Waa inaad sugto 15 ilbiriqsi ka hor intaanad qofkaan mar kale casuunto.",
...
\u{1F451} Golden profile activated!`,
  ...
  admin_view_player_info: (id, xp, level, wins, losses, warnings, muted, banned) => `\u{1F464} **<@${id}>**
XP: ${xp} | Level: ${level} | Wins: ${wins} | Losses: ${losses}
Warnings: ${warnings} | Muted: ${muted ? "Haa" : "Maya"} | Banned: ${banned ? "Haa" : "Maya"}`,
...
Qor \`!start\` si aad u bilowdo ciyaaraha!
